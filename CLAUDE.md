...
│   ├── scripts/                  # fetch-diff.sh, render-review.py, rm-tmp.sh, lib/scratch-guard.sh
│   └── sequencer/programs/
...
│   └── scripts/                  # fetch-diff.sh, rm-tmp.sh, lib/scratch-guard.sh
│
...
- **`scripts/lib/scratch-guard.sh` and `scripts/rm-tmp.sh` are byte-identical across all four
