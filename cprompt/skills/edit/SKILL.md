...
Create or edit an AI-facing prompt (markdown). After producing the output, self-check it against `${CLAUDE_PLUGIN_ROOT}/rules/prompt.md` and fix any violations.
...
1. Read `${CLAUDE_PLUGIN_ROOT}/rules/prompt.md`.
